# Rust Intro Prensentation

An intro presentation about the [Rust Programming Language](http://rust-lang.org). Created from the skeleton of the reveal.js 2.5.0 release.
